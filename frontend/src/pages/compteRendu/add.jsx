...
const AddCompteRendu = () => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault()
        fetch(`${API_BASE_URL}/compte_rendus/`, {
            method: "POST",
            headers: {
                "Content-Type": "application/json",
                // "Authorization": `Bearer ${token}`
            ...
            <div id="kt_app_toolbar" className="app-toolbar py-3 py-lg-6">
                <div id="kt_app_toolbar_container" className="app-container container-xxl d-flex flex-stack">
                    <div className="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                        <h1 className="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">Ajouter une Compte Rendu</h1>
                    ...
                    <form id="kt_ecommerce_edit_order_form" onSubmit={handleSubmit} className="form d-flex flex-column flex-lg-row" >
                        ...
                        <div className="d-flex flex-column flex-lg-row-fluid gap-7 gap-lg-10">
                            <div className="card card-flush py-4">
                                ...
                                <div className="card-body pt-0">
                                    ...
                                    <div className="mb-10 fv-row">
                                        <label className="required form-label">Titre</label>
                                        <input type="text" name="titre" className="form-control mb-2" onChange={handleChange} />
                                        <div className="text-muted fs-7">Saisir le titre du Compte Rendu</div>
                                    </div>
                                    
                                    <div className="mb-10" >
                                        <label className=" required form-label">Réunion</label>
                                                ...
                                                <div data-repeater-list="kt_ecommerce_add_product_options" className="d-flex flex-column gap-3">
                                                    <div data-repeater-item="" className="form-group d-flex flex-wrap align-items-center gap-5">
                                                        <div className="w-100 w-md-200px">
                                                            <select className="form-select" name="reunion" data-placeholder="Sélectionner la Réunion" onChange={handleChange}>
                                                                <option></option>
                                                                {
                                                                    fournisseurs.map((f) => (
                                    ...
                                    {/* <div className="mb-10 fv-row">
                                        ...
                                        <div className="text-muted fs-7">Choisir la date de la Compte Rendu</div>
                                    </div> */}
                                    <div className="mb-10 fv-row">
                                        ...
                                        <div className="text-muted fs-7">Saisir la description du Compte Rendu</div>
                                    </div>
                            ...
                            <div className="d-flex justify-content-end">
                                <a href="/compte/rendu/liste" id="kt_ecommerce_add_product_cancel" className="btn btn-light me-5">Retour</a>
